...
public:
    ...
    static HomeMenuChoice show_gui_menu(std::istream& in, std::ostream& out, const std::string& username, int rating);
    static SeekResult seek_and_wait_for_match(RemoteGameSession& session, std::ostream& out, const std::string& username);
