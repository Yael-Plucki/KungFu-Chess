...
constexpr const char* kSeek = "seek";
constexpr const char* kCancelSeek = "cancel_seek";
constexpr const char* kResign = "resign";
...
constexpr const char* kPlayerDisconnected = "player_disconnected";

struct InboundMessage {
    enum class Kind { Auth, Move, Jump, Ping, Seek, CancelSeek, Resign, Unknown };
